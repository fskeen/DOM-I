...
function createNav (a) {
  let index = navLinks.indexOf(a)
  a.textContent = siteContent["nav"][`nav-item-${index}`]
}

navLinks.forEach(createNav)
...
let textContentP = document.querySelectorAll(".main-content p")
...
let textContentH4 = document.querySelectorAll(".main-content h4")
